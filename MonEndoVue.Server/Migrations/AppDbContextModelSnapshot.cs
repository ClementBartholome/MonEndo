...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MonEndoVue.Server.Data.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("MonEndoVue.Server.Data.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("MonEndoVue.Server.Models.CarnetSante", b =>
                {
                    b.HasOne("MonEndoVue.Server.Data.ApplicationUser", "User")
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
